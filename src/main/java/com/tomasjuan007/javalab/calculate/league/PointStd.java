...
public class PointStd {
    public static void main(String[] args) {
        double[] points_08_09 = {93, 92, 74, 71, 69, 58, 56, 52, 51, 51, 49, 48, 46, 45, 40, 39, 38, 35, 23, 22};
        sd(points_08_09);
        double[] points_09_10 = {86, 74, 69, 67, 66, 65, 62, 61, 59, 59, 55, 45, 45, 44, 43, 41, 39, 28, 26, 23};
        sd(points_09_10);
        double[] points_10_11 = {99, 81, 66, 66, 62, 59, 59, 56, 54, 54, 52, 49, 44, 43, 41, 39, 35, 34, 34, 21};
        sd(points_10_11);
        double[] points_11_12 = {98, 97, 72, 71, 70, 66, 57, 54, 52, 52, 50, 49, 45, 45, 40, 39, 36, 34, 26, 16};
        sd(points_11_12);
        double[] points_12_13 = {100, 81, 77, 75, 70, 63, 54, 49, 47, 44, 44, 44, 42, 41, 40, 37, 36, 33, 33, 31};
        sd(points_12_13);
